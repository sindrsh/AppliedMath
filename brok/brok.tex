...
\net{https://www.skatteetaten.no/bedrift-og-organisasjon/avgifter/mva/slik-fungerer-mva/}{{\textit{Mervardiavgiften}}} (mva.) er en avgift som legges til prisen på de aller fleste varer som selges. Merverdiavgift oppgis som regel som prosentdel av prisen.
} \vsk
...
\eks[1]{ En vare verd 1\,000 kr er rabattert med 20\%.
\abc{
...
\newpage
\eks[2]{En sjokolade koster 9,80 kr, ekskludert mva. På matvarer er det 15\% mva.
	\abc{
\item Hva er vekstfaktoren?	
...
Mellomregningen vi gjorde over kan kanskje virke unødvendig, men utnytter vi skrivemåten for potenser\footnote{Se \mb, s.??} kommer et flott mønster til syne:
\alg{
