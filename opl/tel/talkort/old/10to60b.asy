...
drwnum();
drwlab(i=0);
db(I=1, J=10, sh=pos2+((2a+d-sc)/2,b/15),p=deepgreen,opac=0.2);
...
sh = shift(pos1);
drwnum(2);
db(I=2, J=10, sh=pos1+((2a+d-2sc)/2,b/15),p=deepgreen,opac=0.2);
drwlab(l="tjue",i=0);

sh = shift(pos4);
drwnum(3);
drwlab(l="tretti",i=0);
db(I=3, J=10, sh=pos4+((2a+d-3sc)/2,b/15),p=deepgreen,opac=0.2);

sh = shift(pos3);
drwnum(4);
db(I=4, J=10, sh=pos3+((2a+d-4sc)/2,b/15),p=deepgreen,opac=0.2);
drwlab(l="førti",i=0);
