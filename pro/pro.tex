...
\prbxl{0.55}{Ordet \textit{prosent} betyr rett og slett \textit{av hundre}. Når vi for eksempel sier 30 prosent, er dette derfor det samme som brøken $ \frac{30}{100} $. Og istedenfor å skrive ''prosent'', skriver vi som oftest tegnet  \%.}\qquad
\prbxr{0.35}{Når et tall er gitt i prosent, kalles det et \textit{prosenttall}. 20\%, 143,7\% osv. er altså prosenttall.}\vsk

Som et første eksempel skal vi finne 1\% av 400. Dette betyr at vi skal dele 400 inn i 100 like store biter, og ta én av dem. Som et bilde på dette kan vi se for oss en boks som har verdien 400:
\begin{figure}[hbt]
	\centering 
	\includegraphics[scale=1]{\asym{pro0}} 
\end{figure}
Denne boksen deler vi inn i 100 like store bokser. Hver boks må da ha verdien $ \frac{400}{100}=4 $. 
\begin{figure}[hbt]
	\centering 
	\includegraphics[scale=1]{\asym{pro}} 
\end{figure}
Verdien til 1\% av 400 er det samme som verdien til én av disse 100 boksene:
\alg{
\text{1\% av 400}&=\frac{400}{100}\\&=4
}
\reg[1\% av et tall]{
1\% av et tall finner vi ved å dele tallet med 100.
}
\eks[1]{
Hva er 1\% av 900?

\sv \vsb
\[ \text{1\% av 900}=\frac{900}{100}=9 \]
}
\eks[2]{
Hva er 1\% av 57,8?

\sv \vsb
\[ \text{1\% av 57,8}=\frac{57,8}{100}=0,578 \]
}\vsk
La oss gå videre til å finne 20\% av 400. Dette betyr at vi skal ha 20 ganger mer enn 1\% av 400:\label{20pro}
\alg{
...
&= 80
 ...
 \begin{figure}[hbt]
	\centering 
	\includegraphics[scale=1]{\asym{pro1}} 
\end{figure}
Vi kunne også regnet ut dette direkte ved å skrive 20\% som et brøkuttrykk istedenfor:\vs
 \begin{align*}
 \text{20\% av 400} &=  \frac{20}{100}\cdot 400\br
 & = \frac{20\cdot 4\cancel{00}}{1\cancel{00}} \br
 &= 20\cdot 4 \\
 &=80
 \end{align*}
\reg[\boldmath $ a\%$ av $ b $]{\vsb
	\begin{equation}\label{aproavb}
	a\%\text{ av }b = \frac{a\cdot b}{100}
	\end{equation}
	}
