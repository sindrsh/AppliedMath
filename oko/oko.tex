...
\subsection{Lån}
Noen ganger har vi  ikke nok penger til å kjøpe det vi ønsker oss og må derfor ta opp et lån fra en bank. Banken gir oss da en viss \textit{lånesum} mot at vi betaler tilbake denne, og \textit{renter}, i løpet av en bestemt tid. Det vanligste er at vi underveis betaler banken det som kalles \textit{terminbeløp}, som på sin side består av \textit{avdrag} og renter. Det vi til enhver tid skylder banken kaller vi \textit{gjelden}. La oss se på et eksempel å å holde styr på alle disse begrepene:\vsk
...
Vi har sett hvordan vi må betale renter når vi låner penger av en bank, men hvis vi i steden setter penger (gjør et innskudd) i en bank  \textsl{får} vi renter: \regv
\reg[Innskuddsrente]{
...
\sv
For å beregne innskuddsrenter kan vi anvende \rref{??}. Siden renten er 2\%, er vekstfaktoren 1,02. Originalverdien er 20\,000 og antall endringer (tiden) er 8:
...
\eks[1]{
Du investerer 15\,000 i et aksjefond som har 5\% årlig forventet avkastning. Hvor mye penger er investeringen verd etter 8 år ved en slik avkastning?

\sv
Også for forventet avkastning kan vi bruke \rref{??}. Vekstfaktoren er 1,05, originalverdien er 15\,000 og antall endringer (tiden) er 8:
\[ 15\,000\cdot1,05^8\approx22\,162 \]
Etter 8 år er det forventet at investeringen er verdt 22\,162.
}
\vsk

\info{Spare med innskuddsrente eller aksjefond?}{
Som regel er forventet avkastning på et aksjefond høyere enn innskudsrenten du får i en bank, men ulempen er at forventet avkastning ikke gir noen garantier. Forventet avkastning oppgir bare økningen eksperter antar vil skje. Er du heldig kan økningen bli høyere, er du uheldig kan den bli lavere, og til og med ende opp med å være en \textsl{reduksjon} av investeringen din. I verste fall, rett nok i ekstremt sjeldne tilfeller, kan hele investeringen din ende opp med å bli verd 0\enh{kr}. \vsk
