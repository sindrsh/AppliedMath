...
%License
\newcommand{\lic}{\textit{Matematikkens byggesteiner by Sindre Sogge Heggen is licensed under CC BY-NC-SA 4.0. To view a copy of this license, visit\\ 
...
\newcommand{\oph}[1]{\vspace{15pt} \refstepcounter{opg}\large \textbf{\color{blue}\theopg\;(H)} \vspace{2 pt} \label{#1} \\}
