...
\eks{ \label{vareks}
Gitt datasettet 
\[\color{blue} 2\quad 5\quad 9\quad 6\quad 8 \]
Da har vi at
\[ \text{gjennomsnitt}=\frac{\colb{2+5+9+6+8}}{5}=\colr{6} \]
Og videre er
\alg{
\text{variansen}= \frac{(\colb{2}-\colr{6})^2+(\colb{5}-\colr{6})^2+(\colb{9}-\colr{6})^2+(\colb{6}-\colr{6})^2+(\colb{8}-\colr{6})^2}{5}
}
}
\st{
\textbf{Undersøkelse 1} \os
...
\st{
\textbf{Undersøkelse 2} \os
Gjennomsnittet fant vi på side ??. Vi utvider frekvenstabellen vår fra side ??:
\begin{center}
