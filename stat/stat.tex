...
I et datasett er det gjerne svar som er helt eller tilnærmet like, og som gjentar seg. Dette betyr at vi kan si noe om hva som gjelder for mange; en \textit{tendens}. De matematiske begrepene som forteller noe om dette kalles \textit{sentralmål}. De vanligste sentralmålene er \textit{typetall}, \textit{gjennnomsnitt} og \textit{median}. \vsk
...
\st{
\textbf{Undersøkelse 2} \os
I datasettet er det verdien 4 som opptrer flest (tre) ganger. (Dette kan vi se fra selve datasett på s. \pageref{undersok}, fra frekvenstabellen på s. \pageref{frkvtbund2}, fra søylediagrammet på s. \pageref{soylund2} eller sektordiagrammet på s. \pageref{sektorund2}.) \vsk
...
Dette er jo ingenting annet enn divisjonse\footnote{se \mb, s. 23.}: \regv
...
\subsection{Median}
\reg[Median]{Medianen er tallet som ender opp i midten av datasettet når det rangeres fra tallet med lavest til høgest verdi.\vsk
