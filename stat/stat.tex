...
\info{Å lage tegne et sektordiagram for hand
}{
Skal du selv tegne et sektordiagram, trenger du kunnskaper om vinkler og om brøkandeler. Se \refsec{brkdlavhel}, \mb, s. ?? og oppgave \ref{lagsekt}.}
\newpage
...
I et datasett det gjerne være svar som er helt eller veldig like, og som gjentar seg. Dette betyr at vi kan si noe om hva som gjelder for mange; en \textit{tendens}. De matematiske begrepene som forteller noe om dette kalles \textit{sentralmål}. De vanligste sentralmålene er \textit{typetall}, \textit{gjennnomsnitt} og \textit{median}. \vsk
...
\st{
\textbf{Undersøkelse 2} \os
I datasettet er det tallet 4 som opptrer flest (tre) ganger. (Dette kan vi se fra selve datasett på s. \pageref{undersok}, fra frekvenstabellen på s. \pageref{frkvtbund2}, fra søylediagrammet på s. \pageref{soylund2} eller sektordiagrammet på s. \pageref{sektorund2}.) \vsk
...
\st{
	...
	(Utregning utelatt)
	\begin{itemize}
		\item For mobiltelefoner er variansen 17\,781,25 og standardavviket ca. $ 133,4 $.
		\item For mobiltelefoner uten smartfunksjoner er variansen $ 318\,848.\bar{3} $ og standardavviket ca. $ 17,87 $
		\item For mobiltelefoner med smartfunksjoner er variansen $245\,847.91\bar{6} $ og standardavviket ca. 495,83.
	\end{itemize}
}
