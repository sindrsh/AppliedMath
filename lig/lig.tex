...
Vi tegner grafene\footnote{For hvordan tegne en graf, se  se \mb, s. ?? og ??.} inn i det samme koordinatsystemet:
\fig{lig1}
Vi leser av at grafene har samme verdi når $ {x=3} $, og da har begge funksjonene verdien 7. Altså er skjæringspunktet $ (3, 7) $. \vsk
