...
\item Hvor langt kjører en bil som holder farten  90\enh{km/h} i 5 timer?
...
\item I formelen er nå farten $ 90 $ og tiden $ 5 $, og da er
\[ s=90\cdot5=450 \]
Altså har bilen kjørt 450\enh{km}
\item Her må vi må enten gjøre om farten til km/min eller tiden til timer. Vi velger å gjøre om minutt til timer:
\alg{
45\enh{minutt}&=\frac{45}{60}\enh{timer} \br
&=\frac{3}{4}\enh{timer}
}
}
I formelen altså nå farten 90 og tiden $ \dfrac{3}{4} $, og da er
...
\item Vekten er gitt i gram og kilopris er gitt i kr/kg. Før vi bruker formelen gjør vi om vekten til målt i kg (se ??):
...
\subsubsection{Når formelen er ukjent}
...
\end{itemize}
Sett opp et uttrykk for hvor mye du må betale for en taxitur.

\sv
Her har vi fire størrelser som er involvert, og som vi gir disse navnene:
\begin{itemize}
	\item \textbf{fastpris}\\
	De 50 kronene vi må betale uansett.
	\item \textbf{kilometerpris} \\
	Det vi må betale per kilometer.
	\item \textbf{total pris} \\
	Det vi må betale for taxi-turen. \\
	\item \textbf{strekning} \\
	Antall kilometer vi blir kjørt.
\end{itemize}
}
