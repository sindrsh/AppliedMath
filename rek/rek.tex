...
\reg[Å gange heltall med 10, 100 osv.]{
	\vs
	\begin{itemize}
		\item Svaret når man gangar et heltall med 10, får man ved å legge til sifferet 0 bak heltallet.
		\item Svaret når man gangar et heltall med 100, får man ved å legge til sifrene 00 bak heltallet.
...
\reg[Å gange desimaltall med 10, 100 osv.]{
	\vs
	\begin{itemize}
		\item Svaret når man gangar et desimaltall med 10 får man ved å flytte komma en plass mot høgre.
		\item Svaret når man gangar et heltall med 100, får man ved å flytte komma to plasser mot høgre.
		\item Det samme mønsteret gjelder for tallene 1\,000, 10\,000 osv.
	\end{itemize}
}
\eks[1]{\vsb \vsb
...
\eks[2]{ \vsb \vsb
	\alg{
		...
		8\colr{,}02\cdot100&=802\colr{,}=802 \vn
		0\colr{,}57\cdot 100 &=05\colr{,}7=5\colr{,}7 \vn
...
\fork{Ganging med 10, 100, 1\,000 osv.}
{Lat oss se på reknestykket $ 3\cdot 10 $:
	\fig{gang4}
	Men 10 einarar kan vi liksågodt slå samen til én tier. På bildet over har vi 3 radar med 10 enere, så dette kan vi altså slå sammen til 3 tiere.
	\fig{gang4a}
	Og 3 tierer blir 30.
	\fig{gang4b}
	Lat oss videre se på reknestykket $ 23\cdot 10 $:
	\fig{gang5}
	Me fortsett med å slå saman 10 einarar til éin tiar, og tek i tillegg med oss at 10 tiarar er éin hundrar. Dei to radane med tiarar gir oss derfor 2 hundrarar og dei tre radane med einarar gir oss 3 tiarar.
	\fig{gang5a}
