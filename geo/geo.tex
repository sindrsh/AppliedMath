...
For å regne ut volumet av de mest elementære figurene vi har, kan det være lurt å bruke begrepet \textit{grunnflate}. Slik som for en grunnlinje\footnote{se \mb, s. 81.}, er det vårt valg av grunnflate som bestemer hvordan vi skal regne ut høgden. For prismen fra forrige side, er det naturlig å velge flaten som ligger horisontalt til å være grunnflaten, og for å indikere dette brukes ofte $ G $:
\fig{vol2b}
